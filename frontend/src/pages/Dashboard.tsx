        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link to="/automation">
              <Button
                variant="outline"
                className="h-auto w-full flex-col p-6 items-start gap-2 hover:border-blue-500 hover:bg-blue-50"
              >
                ...
                <div className="flex flex-col items-start">
                  ...
                  <span className="text-xs text-muted-foreground whitespace-normal text-left">
                    Automatisch alle Artikel importieren
                  </span>
                </div>
              </Button>
            </Link>
            ...
            <Link to="/articles">
              <Button
                variant="outline"
                className="h-auto w-full flex-col p-6 items-start gap-2 hover:border-green-500 hover:bg-green-50"
              >
                <Package className="w-8 h-8 text-green-600 mb-2" />
                <div className="flex flex-col items-start">
                  <span className="font-semibold text-lg">Artikel Verwalten</span>
                  <span className="text-xs text-muted-foreground whitespace-normal text-left">
                    Gecrawlte Artikel anzeigen & bearbeiten
                  </span>
                </div>
              </Button>
            </Link>
            ...
            <Link to="/labels">
              <Button
                variant="outline"
                className="h-auto w-full flex-col p-6 items-start gap-2 hover:border-primary hover:bg-primary/5"
              >
                <Tags className="w-8 h-8 text-primary mb-2" />
                <div className="flex flex-col items-start">
                  <span className="font-semibold text-lg">Neues Label</span>
                  <span className="text-xs text-muted-foreground whitespace-normal text-left">
                    Manuell erstellen oder aus Screenshot
                  </span>
                </div>
              </Button>
            </Link>
            ...
            <Link to="/excel">
              ...
              >
                ...
                <div className="flex flex-col items-start">
                  ...
                  <span className="text-xs text-muted-foreground whitespace-normal text-left">
                    Produktdaten aus Excel hochladen
                  </span>
                </div>
              </Button>
            </Link>
            ...
            <Link to="/print">
              <Button
                variant="outline"
                className="h-auto w-full flex-col p-6 items-start gap-2 hover:border-purple-500 hover:bg-purple-50"
              >
                <Printer className="w-8 h-8 text-purple-600 mb-2" />
                <div className="flex flex-col items-start">
                  <span className="font-semibold text-lg">Druck-Setup</span>
                  <span className="text-xs text-muted-foreground whitespace-normal text-left">
                    Druck-Layout konfigurieren und PDF exportieren
                  </span>
                </div>
              </Button>
            </Link>
