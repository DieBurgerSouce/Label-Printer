...
export const KeyboardShortcutsList = () => {
  ...
  const categories = {
    ...
    'Canvas Controls': shortcuts.filter(
      (s) => s.description.includes('Zoom') || s.description.includes('Reset Zoom')
    ),
    'View Controls': shortcuts.filter((s) => s.description.includes('Toggle')),
    Selection: shortcuts.filter(
      (s) => s.description.includes('Selection') || s.description.includes('Select All')
    ),
    Print: shortcuts.filter(
      (s) => s.description.includes('Print') || s.description.includes('Reset Print')
    ),
